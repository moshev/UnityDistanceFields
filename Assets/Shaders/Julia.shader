Shader "Unlit/Julia" {
   Properties {
        _Iterations_1("Julia: Iterations", Float) = 16
        _Cx_1("Julia: C x", Float) = 0.6651410179788055
        _Cy_1("Julia: C y", Float) = 0.995165511524831
        _Cz_1("Julia: C z", Float) = -0.09786148786209856
        _Cw_1("Julia: C w", Float) = 0.42337454445066547
