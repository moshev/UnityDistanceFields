...
float _dist_xform_4(float3 p) {
    return _dist_6(qrot(qinv(float4(0,0,0,1)), p - float3(-0.8559999,-0.872,0)));
}
...
float _dist_xform_5(float3 p) {
    return _dist_7(qrot(qinv(float4(0,0,0,1)), p - float3(1.256,-0.375,0)));
}
...
float _dist_xform_7(float3 p) {
    return _dist_11(qrot(qinv(float4(0,0,0,1)), p - float3(0.2649999,-0.4,0)));
}
